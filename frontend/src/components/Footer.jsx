...
function Footer() {
    return (
        <div className=''>
            <footer className="footer pt-8 footer-center  bg-white text-primary-content dark:bg-slate-900">
                <div className="bg-pink-600 p-10 max-w-full container mx-auto md:px-20 px-4">
                    <aside>
